...
namespace Proyecto_Omb_SQL_SERVER.Vistas
{
    public partial class Listado_Beneficiarios : MaterialForm
    {
        ...
        private void PDF_Click(object sender, EventArgs e)
        {
            ...
            PdfPTable pdfTable = new PdfPTable(DataGrid_Listado_Ben.ColumnCount);
            ...
            foreach (DataGridViewColumn column in DataGrid_Listado_Ben.Columns)
            {
            ...
            foreach (DataGridViewRow row in DataGrid_Listado_Ben.Rows)
            {
                try
                {
